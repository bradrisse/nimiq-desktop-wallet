...
class Loading extends React.Component {
    ...
    render() {
        const {nimiq, t} = this.props;

        return (
            <FullHeight style={{background: '#042146'}}>
                    ...
                    <Grid item xs={12}>
                        <Grid container alignItems={"center"} direction={"row"} justify={"center"} style={{ height: "100%" }}>
                            <Grid item>
                                ...
                                <Typography style={{color: 'white'}} align="center">{nimiq.message} {t('loading.syncing')} {nimiq.blockHeight}</Typography>
                            </Grid>
                        </Grid>
                    </Grid>
                </Grid>
